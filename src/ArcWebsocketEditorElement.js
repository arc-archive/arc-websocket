...
import { ArcModelEvents, RequestEventTypes, TransportEvents } from '@advanced-rest-client/arc-events';
...
export class ArcWebsocketEditorElement extends ArcResizableMixin(EventsTargetMixin(LitElement)) {
  static get styles() {
  ...
  [connectTemplate]() {
    ...
    return html`
    <anypoint-button aria-label="Activate to connect to the server" @click="${this.connect}" ?compatibility="${compatibility}">Connect</anypoint-button>
    `;
  }
  ...
  [tabsTemplate]() {
    ...
    <anypoint-tabs
      ...
      class="editor-tabs"
    >
      <anypoint-tab ?compatibility="${compatibility}">Body</anypoint-tab>
    </anypoint-tabs>
    `;
  }
